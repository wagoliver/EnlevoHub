...
const registerContractorSchema = z.object({
...
type RegisterContractorFormData = z.infer<typeof registerContractorSchema>
...
export function RegisterContractor() {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<RegisterContractorFormData>({
    resolver: zodResolver(registerContractorSchema),
  })

  const onSubmit = async (data: RegisterContractorFormData) => {
    setIsLoading(true)
    try {
    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden md:flex md:w-1/2 flex-col items-center justify-center bg-[#21252d] px-12">
        ...
        <p className="mt-2 text-center text-white/40 text-sm max-w-xs">
          Informe o CNPJ da empresa construtora para vincular sua conta
        </p>
      </div>
      ...
      <div className="flex w-full md:w-1/2 flex-col items-center justify-center bg-white px-6 py-12 overflow-y-auto">
        <div className="w-full max-w-sm">
          ...
          <h2 className="text-2xl font-semibold text-neutral-900">Cadastro de Empreiteiro</h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="tenantDocument">CNPJ da Empresa (Construtora)</Label>
              <Input
                id="tenantDocument"
            ...
            {/* Document (CPF/CNPJ do empreiteiro) */}
            <div className="space-y-1.5">
              <Label htmlFor="document">Seu CPF/CNPJ</Label>
              <Input
                id="document"
            ...
            <div className="space-y-1.5">
              ...
              {errors.specialty && (
                <p className="text-sm text-error-600">{errors.specialty.message}</p>
              )}
            </div>
